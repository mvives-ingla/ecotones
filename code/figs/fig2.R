...
(microclim <- ovi.plot + guides(fill = "none") +
  ...
  tmax.plot + fol.temp.plot + labs(y = "Temperature<br>(ºC)",
                                   x = "Microhabitat") +
  offset.plot + labs(y = "Thermal offset<br>(sensor - meteo,<br>(K)") +
   fol.offset.plot + labs(y = "Thermal offset<br>(leaf - air,<br>(K)",
                                       x = "Microhabitat") +
  sd.boxplot + labs(y = "Daily thermal<br>variability<br>(Daily SD, K)") +
   leafsd.plot + labs(y = "Spatial thermal<br>heterogeneity<br>(Daily SD, K)",
                                  x = "Microhabitat") +
